...
var operations = [
  {value: '/', color: '#1A237E', altColor: '#1A237E', operation: OPERATION_DIVIDE},
  {value: '-', color: '#1A237E', altColor: '#1A237E', operation: OPERATION_SUBTRACT},
  {value: '+', color: '#1A237E', altColor: '#1A237E', operation: OPERATION_ADD},
  {value: 'x', color: '#1A237E', altColor: '#1A237E', operation: OPERATION_MULTIPLY}
];
    ...
    return (
      <View style={[styles.row, styles.actionRow]}>
        <TouchableHighlight
          ...
          onPress={undo}>
          <Text style={[styles.actionButtonText, styles.actionButtonUndoText]}>Clear</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={[styles.actionButton, styles.actionButtonEquals]}
          unerlayColor='#bfe4be'
          onPress={calculate}>
          <Text style={[styles.actionButtonText, styles.actionButtonEqualsText]}>Calculate</Text>
        </TouchableHighlight>
      </View>
    )
  }
